...
class Person
    ...
    def start_conversation(friend_instance, given_topic)
        ...
        when "politics"
            current_happiness_points = self.happiness - 2
            friends_happiness = friend_instance.happiness - 2
            self.happiness=(current_happiness_points)
            friend_instance.happiness=(friends_happiness)
            "blah blah partisan blah lobbyist"

        when "weather"
            current_happiness_points = self.happiness + 1
            friends_happiness = friend_instance.happiness + 1
            self.happiness=(current_happiness_points)
            friend_instance.happiness=(friends_happiness)
